    ...
    <div className="space-y-6">
        ...
        <div className="lg:col-span-4 sticky top-20 bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-5 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            {isRendering ? (
              ...
              <span className="inline-flex items-center gap-1 text-[11px] font-medium text-rose-700 bg-rose-50 px-2 py-0.5 rounded-full border border-rose-200/80">
          ...
          <div className="space-y-1 text-xs text-slate-600 bg-slate-50/80 p-3 rounded-xl border border-slate-100">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-slate-800">#{sampleItem.index}</span>
            </div>
            <div className="flex justify-between">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 p-4 flex items-center justify-between shadow-2xs">
        ...
        <button
          type="button"
          onClick={onContinue}
          className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs sm:text-sm rounded-xl shadow-xs transition-all flex items-center gap-2"
        >
          <span>Tiếp tục</span>
